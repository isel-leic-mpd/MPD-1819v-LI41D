...
public class WeatherWebApiJson extends BaseWeatherApi {
    ...
    @Override
    public CompletableFuture<LocationInfo[]> search(String query) {
    ...
    public CompletableFuture<WeatherInfo[]> pastWeather(double lat, double log, LocalDate from, LocalDate to) throws IOException {
        ...
        return req.getContent(url).thenApply(this::toWeatherInfoArray);
    }

    private WeatherInfo[] toWeatherInfoArray(String body) {
